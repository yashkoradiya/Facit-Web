...
class TransferReviewPrices extends Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedTransfers: [],
  ...
  render() {
    ...
    const { selectedTransfers, saveSuccess, publishing, errors } = this.state;
...
TransferReviewPrices.propTypes = {
...
export default connect(mapStateToProps, mapDispatchToProps)(TransferReviewPrices);
