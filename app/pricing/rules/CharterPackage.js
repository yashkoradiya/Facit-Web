...
class CharterFlight extends Component {
  render() {
    const {
      data,
      onFilterChanged,
    ...
    return (
      initialData && (
        <RuleTab
          ...
          data={data}
          agGridKey={'charterPackageRulesOverview'}
          createButtons={[
            {
              label: 'Charter Package',
              createUrl: '/pricing/rules/templates/create/charter-package',
              roles: ['packagetemplates.charterpackage.write']
            }
          ]}
